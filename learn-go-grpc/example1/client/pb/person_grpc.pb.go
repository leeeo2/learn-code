...
type PersonClient interface {
	GetPerson(ctx context.Context, in *GetPersonReq, opts ...grpc.CallOption) (*GetPersonRes, error)
}
...
func (c *personClient) GetPerson(ctx context.Context, in *GetPersonReq, opts ...grpc.CallOption) (*GetPersonRes, error) {
	out := new(GetPersonRes)
	err := c.cc.Invoke(ctx, "/pb.Person/GetPerson", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PersonServer interface {
	GetPerson(context.Context, *GetPersonReq) (*GetPersonRes, error)
...
func (UnimplementedPersonServer) GetPerson(context.Context, *GetPersonReq) (*GetPersonRes, error) {
...
func _Person_GetPerson_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.Person/GetPerson",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PersonServer).GetPerson(ctx, req.(*GetPersonReq))
	}
