...
type MyServiceClient interface {
	Echo(ctx context.Context, in *StrMsg, opts ...grpc.CallOption) (*StrMsg, error)
}
...
func (c *myServiceClient) Echo(ctx context.Context, in *StrMsg, opts ...grpc.CallOption) (*StrMsg, error) {
	out := new(StrMsg)
...
type MyServiceServer interface {
	Echo(context.Context, *StrMsg) (*StrMsg, error)
...
func (UnimplementedMyServiceServer) Echo(context.Context, *StrMsg) (*StrMsg, error) {
...
func _MyService_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MyServiceServer).Echo(ctx, req.(*StrMsg))
	}
